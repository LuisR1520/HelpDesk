...
class Email extends PHPMailer{
    ...
    protected $gCorreo = 'soporte@ampyme.gob.pa';//aqui tu correo@dominio.com
    protected $gContrasena = '@mpYme2120';//aqui tu pass
    ...
    public function ticket_abierto($tick_id){
        ...
        //IGual//
        $this->IsSMTP();
        $this->Host = 'mail.ampyme.gob.pa';//Aqui el server
        $this->Port = 587 ;//Aqui el puerto
        $this->SMTPAuth = true;
        $this->Username = 'soporte@ampyme.gob.pa';
        $this->Password = '@mpYme2120';
        $this->From = 'soporte@ampyme.gob.pa';
        $this->SMTPSecure = 'tls';
        $this->FromName = $this->tu_nombre = "Ticket Abierto ".$id;
        $this->CharSet = 'UTF8';
        $this->addAddress('lrodriguez@ampyme.gob.pa');
        $this->addAddress('ecastillo@ampyme.gob.pa');
        ...
        $cuerpo = str_replace("lblcorreousu", $correo, $cuerpo);
