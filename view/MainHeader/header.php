<header class="site-header">
    <div class="container-fluid">
        ...
        <a href="/view/Home" class="site-logo">
            <img class="hidden-md-down" src="../../public/img/Logos-AMPYME-2021.png" alt="">
            <img class="hidden-lg-up" src="../../public/img/logito.png" alt="">
        </a>
                ...
                <div class="dropdown dropdown-notification notif">
                    ...
                    <div class="dropdown user-menu">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dd-user-menu">
                         ...
                         <a class="dropdown-item"  href="../CambiarContraseña/" id="con"><span class="font-icon glyphicon glyphicon-user"></span>Perfil</a>
